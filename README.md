...
(which I would recommend reading) and a number of explanations here are based on that post. For a more thorough understanding of some of these concepts, I would encourage you to go through the [notes](http://cs231n.github.io/) from [Stanford’s course on ConvNets](http://cs231n.stanford.edu/) as well as other excellent resources mentioned under References below.
...
![img20-3](https://ahmedbesbes.com/images/GIF.gif)
